...
part1 =
    clean
        >> answerGroups
        >> List.map (characterSet >> Set.size)
        >> List.sum
...
answerGroups : String -> List String
answerGroups =
    String.split "\n\n"


characterSet : String -> Set.Set Char
characterSet =
    String.replace "\n" ""
        >> String.toList
        >> Set.fromList
...
part2 =
    clean
        ...
        >> List.map
            (String.lines
                >> List.map characterSet
                >> bind (List.foldl Set.intersect) firstSet
            )
        >> List.map Set.size
        >> List.sum
...
firstSet : List (Set Char) -> Set Char
firstSet =
